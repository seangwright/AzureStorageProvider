...
namespace AzureStorageProvider
{
    ...
    public class FileStream : CMS.IO.FileStream
    {
        ...
        private readonly FileMode _fileMode = FileMode.Open;
        private readonly FileAccess _fileAccess = FileAccess.ReadWrite;
        private readonly FileShare _fileShare = FileShare.Read;
        ...
        public override int Read(byte[] array, int offset, int count) => _stream.Read(array, offset, count);
        ...
        public override long Seek(long offset, SeekOrigin loc) => _stream.Seek(offset, loc);
